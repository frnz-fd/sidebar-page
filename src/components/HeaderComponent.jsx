    ...
    return (
        <header className=' w-full h-fit '>
            ...
            <section className="max-md: flex justify-end gap-4 py-4 px-20 max-xxl:px-5 border-b border-b-gray-200 text-sm font-bold text-gray-600">
                <div className='w-fit h-fit'><svg width={20} height={20} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z"/></svg></div>
                <p className=''> نیویورک،بروکلین، 3453</p>
                <div className='text-gray-300'>|</div>
                <div className='w-fit h-fit'><svg width={20} height={20} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z" /></svg></div>
            ...
            <div className={`navbar-menu relative z-50  ${isMenuOpen ? 'block' : 'hidden'}`}>
                ...
                <div className="bg-hamburger-pattern text-white w-full h-full fixed  top-0 left-0  p-8">
                    ...
                    <div className='flex gap-44 max-sm:gap-10 max-sm:block'>

                        <ul className='p-2 mt-36 '>
                            <li className='cursor-pointer hover:bg-orange-600 hover:rounded-full p-4'>
                        ...
                        <ul className='text-right list-none relative max-w-[600px] mt-10 p-2'>
