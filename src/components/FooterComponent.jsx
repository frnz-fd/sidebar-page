            ...
            <article className='bg-footer-blue py-14 mt-20 flex justify-center gap-36 px-4 max-xl:block'>
                ...
                <article className='flex gap-32 max-xmd:gap-12  max-md:block mt-10 max-md:mt-8 max-xl:mt-20 max-xl:justify-center'>
                    ...
                    <section className='max-w-[700px] '>
                        <h3 className='text-gray-300 text-2xl font-bold text-right max-ssm:w-full max-ssm:text-xl'>
                            از آخرین به روز رسانی های حقوقی، مقالات روشنگر و تحلیل های تخصصی مطلع باشید.
                        </h3>
                        <div className='flex mt-10 justify-between max-ssm:w-11/12 mx-auto'>
                        ...
                        <hr className='my-4 mx-2 border-gray-300 max-ssm:w-11/12 mx-auto'></hr>
                    </section>
                </article>
